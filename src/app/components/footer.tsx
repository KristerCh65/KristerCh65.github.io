  ...
  return (
    ...
    <footer className="bg-white shadow dark:bg-gray-900">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {year} <a href="https://kristerch65.github.io/" className="hover:underline">Krister Munguia</a>. Portafolio ☺️.
          </span>
